...
def test_release_freezes_contracts_and_certificates_and_requires_exact_coverage() -> None:
    ...
    assert "quality_contract_compiler.v4" in manifest.quality_contract_compiler_versions
    ...
    assert manifest.task_pattern_runtimes == {"legal_task_pattern_runtime.v1": "1.0.0"}
