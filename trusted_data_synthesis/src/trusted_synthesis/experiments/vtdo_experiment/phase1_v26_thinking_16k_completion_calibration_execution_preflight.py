...
from trusted_synthesis.experiments.vtdo_experiment.phase1_v26_thinking_16k_completion_calibration_contracts import (  # noqa: E501
    ...
    exact_16k_execution_contract_id,
    exact_16k_outcome_interpretation_id,
    exact_16k_runner_preflight_report_id,
    load_canonical_json,
    sha256,
    sha256_text,
    write_json_atomic,
...
from trusted_synthesis.experiments.vtdo_experiment.phase1_v26_thinking_16k_completion_calibration_execution import (  # noqa: E501
    JournaledExact16KClient,
    _cp_upper,
    _next_transition,
    execute_exact_16k_job_raw,
    load_static_inputs,
...
CLIENT_BINDING_VERSION: Final[Literal["finance_v26_exact_16k_client_binding_fixture.v1"]] = (
    "finance_v26_exact_16k_client_binding_fixture.v1"
)
RUNNER_FIXTURE_VERSION: Final[Literal["finance_v26_exact_16k_runner_fixture.v1"]] = (
    "finance_v26_exact_16k_runner_fixture.v1"
)
PRECALL_RECOVERY_VERSION: Final[Literal["finance_v26_exact_16k_precall_recovery_fixture.v1"]] = (
    "finance_v26_exact_16k_precall_recovery_fixture.v1"
)
DESTRUCTIVE_VERSION: Final[Literal["finance_v26_exact_16k_runner_destructive.v1"]] = (
    "finance_v26_exact_16k_runner_destructive.v1"
)
USAGE_FIXTURE_VERSION: Final[Literal["finance_v26_exact_16k_usage_fixture.v1"]] = (
    "finance_v26_exact_16k_usage_fixture.v1"
)
...
class Exact16KClientBindingAudit(FrozenModel):
    ...
    representative_certificate: Exact16KRequestBindingCertificate
    ...
    schema_version: Literal["finance_v26_exact_16k_client_binding_fixture.v1"] = (
        CLIENT_BINDING_VERSION
    )

    @model_validator(mode="after")
    def validate_audit(self) -> Exact16KClientBindingAudit:
        if (
            ...
            or self.representative_certificate.request_max_tokens != 16384
        ):
            raise ValueError("v26.104 client binding fixture changed")
        if self.audit_id != client_binding_audit_id(self):
            raise ValueError("v26.104 client binding audit identity mismatch")
        return self
...
class DirectFixtureRow(FrozenModel):
    ...
    def validate_row(self) -> DirectFixtureRow:
        if self.expected_observation_semantic_hashes != self.observed_observation_semantic_hashes:
            raise ValueError("v26.104 direct fixture observations changed")
        if not (
            ...
            raise ValueError("v26.104 direct fixture certificate denominator changed")
        if self.row_id != direct_fixture_row_id(self):
            raise ValueError("v26.104 direct fixture identity mismatch")
        return self
...
class RescueFixtureRow(FrozenModel):
    ...
    all_rescue_calls_exact_16k_request_bound: Literal[True] = True
    ...
    def validate_row(self) -> RescueFixtureRow:
        if self.row_id != rescue_fixture_row_id(self):
            raise ValueError("v26.104 Rescue fixture identity mismatch")
        return self
...
class RunnerFixtureAudit(FrozenModel):
    ...
    length_failure_transition_control: Literal["true_two_stage_thinking_decision_protocol_only"] = (
    ...
    schema_version: Literal["finance_v26_exact_16k_runner_fixture.v1"] = RUNNER_FIXTURE_VERSION

    @model_validator(mode="after")
    def validate_audit(self) -> RunnerFixtureAudit:
        if tuple(item.failure_type for item in self.rescue_rows) != RESCUE_FAILURE_TYPES:
            raise ValueError("v26.104 Rescue fixture denominator changed")
        if self.audit_id != runner_fixture_audit_id(self):
            raise ValueError("v26.104 Runner fixture identity mismatch")
        return self
...
class ProviderUsageFixtureAudit(FrozenModel):
    ...
    exact_request_max_tokens: Literal[16384] = 16384
    provider_accounting_margin_tokens: Literal[1] = 1
    accounting_admissible_completion_tokens: Literal[16385] = 16385
    exact_bound_completion_usage_admitted: Literal[True] = True
    one_token_excess_usage_admitted_as_accounting_only: Literal[True] = True
    one_token_excess_actual_usage_charged_without_clipping: Literal[True] = True
    one_token_excess_length_failure_remained_completion_failure: Literal[True] = True
    two_token_excess_rejected_as_instrument_failure: Literal[True] = True
    two_token_excess_completion_rescue_authorized: Literal[False] = False
    request_body_max_tokens_changed_by_accounting_margin: Literal[False] = False
    request_accounting_upper_bound_includes_margin: Literal[True] = True
    rescue_reserve_includes_accounting_margin: Literal[True] = True
    final_answer_reserve_includes_accounting_margin: Literal[True] = True
    scripted_provider_call_count: Literal[4] = 4
    real_provider_call_count: Literal[0] = 0
    model_client_constructed: Literal[False] = False
    gpu_jobs: Literal[0] = 0
    schema_version: Literal["finance_v26_exact_16k_usage_fixture.v1"] = USAGE_FIXTURE_VERSION

    @model_validator(mode="after")
    def validate_audit(self) -> ProviderUsageFixtureAudit:
        if self.accounting_admissible_completion_tokens != (
            self.exact_request_max_tokens + self.provider_accounting_margin_tokens
        ):
            raise ValueError("v26.104 Usage fixture accounting ceiling changed")
        if self.audit_id != provider_usage_fixture_audit_id(self):
            raise ValueError("v26.104 Usage fixture identity mismatch")
        return self
...
class PrecallRecoveryAudit(FrozenModel):
    ...
    off_compiler_rescue_exact_16k_request_bound: Literal[True] = True
    model_client_constructed: Literal[False] = False
    model_api_calls: Literal[0] = 0
    gpu_jobs: Literal[0] = 0
    schema_version: Literal["finance_v26_exact_16k_precall_recovery_fixture.v1"] = (
    ...
    def validate_audit(self) -> PrecallRecoveryAudit:
        if self.recovered_artifact_id != self.recovery_artifact_id:
            raise ValueError("v26.104 raw-only recovery Artifact changed")
        if self.audit_id != precall_recovery_audit_id(self):
            raise ValueError("v26.104 pre-call/recovery audit identity mismatch")
        return self
...
class DestructivePreflightAudit(FrozenModel):
    ...
    model_api_calls: Literal[0] = 0
    gpu_jobs: Literal[0] = 0
    schema_version: Literal["finance_v26_exact_16k_runner_destructive.v1"] = DESTRUCTIVE_VERSION

    @model_validator(mode="after")
    def validate_audit(self) -> DestructivePreflightAudit:
        if self.rejected_mutation_count != len(self.mutation_results):
            raise ValueError("v26.104 destructive denominator changed")
        if self.audit_id != destructive_preflight_audit_id(self):
            raise ValueError("v26.104 destructive audit identity mismatch")
        return self
...
class FixtureEvent(FrozenModel):
    ...
    completion_tokens_override: int | None = Field(default=None, ge=1)
...
def client_binding_audit_id(value: Exact16KClientBindingAudit) -> str:
    return _identity(value, "audit_id", "finance_v26_exact_16k_client_binding_fixture:")


def direct_fixture_row_id(value: DirectFixtureRow) -> str:
    return _identity(value, "row_id", "finance_v26_exact_16k_direct_fixture:")


def rescue_fixture_row_id(value: RescueFixtureRow) -> str:
    return _identity(value, "row_id", "finance_v26_exact_16k_rescue_fixture:")


def runner_fixture_audit_id(value: RunnerFixtureAudit) -> str:
    return _identity(value, "audit_id", "finance_v26_exact_16k_runner_fixture:")


def provider_usage_fixture_audit_id(value: ProviderUsageFixtureAudit) -> str:
    return _identity(value, "audit_id", "finance_v26_exact_16k_usage_fixture:")


def precall_recovery_audit_id(value: PrecallRecoveryAudit) -> str:
    return _identity(value, "audit_id", "finance_v26_exact_16k_precall_recovery_fixture:")


def destructive_preflight_audit_id(value: DestructivePreflightAudit) -> str:
    return _identity(value, "audit_id", "finance_v26_exact_16k_runner_destructive:")


class ScriptedProviderClient:
    def __init__(self, config: AgentModelConfig, events: Sequence[FixtureEvent]) -> None:
        self.config = require_exact_16k_model_config(config)
    ...
    def _telemetry(
        ...
        *,
        ...
        response_model: str | None = EXACT_16K_MODEL_ID,
        ...
        completion_tokens = completion_tokens_override or 64
        reasoning_tokens = (
            completion_tokens if finish_reason == "length" else min(32, completion_tokens)
        )
        total_tokens = prompt_tokens + completion_tokens
        envelope = (
            RedactedProviderResponseEnvelope(
                response_model=response_model or EXACT_16K_MODEL_ID,
        ...
        telemetry = ModelCallTelemetry(
            ...
            model_requested=EXACT_16K_MODEL_ID,
            model_selected=EXACT_16K_MODEL_ID,
            response_model=response_model,
            ...
            reasoning_tokens=reasoning_tokens if http_success else None,
    ...
    def complete_json_certified(
        ...
        if certificate != expected:
            raise LLMClientError("scripted exact 16K request certificate changed")
        ...
        if event.payload is not None:
            ...
            telemetry, _ = self._telemetry(
                ...
                finish_reason="stop",
                json_success=True,
                completion_tokens_override=event.completion_tokens_override,
            )
...
def _projection_payloads(trajectory: Trajectory) -> tuple[dict[str, Any], ...]:
    ...
    if not isinstance(result, Mapping):
        raise ValueError("v26.104 fixture trajectory lacks a final result")
...
def _observation_semantic_hash(observation: AgentToolObservation) -> str:
    return canonical_hash(
        ...
        prefix="finance_v26_exact_16k_observation_semantics:",
    )


def _make_provider_usage_semantics(static: Any) -> ProviderUsageSemanticsContract:
    usage = static.provider_usage_semantics
    if (
        usage.contract_id != EXPECTED_PROVIDER_USAGE_SEMANTICS_ID
        or usage.exact_request_completion_bound_tokens != 16384
        or usage.maximum_accounting_admissible_completion_tokens != 16385
        or usage.rollout_upper_bound_tokens != 240000
    ):
        raise ValueError("v26.104 Provider Usage semantics binding changed")
    return usage


def _make_interpretation() -> Exact16KOutcomeInterpretationContract:
    values = {
        "zero_failure_cp95_upper_bound": _cp_upper(0, 32),
        "one_failure_cp95_upper_bound": _cp_upper(1, 32),
    }
    provisional = Exact16KOutcomeInterpretationContract.model_construct(
        contract_id="pending",
        **values,
    )
    return Exact16KOutcomeInterpretationContract(
        contract_id=exact_16k_outcome_interpretation_id(provisional),
        **values,
    )


def _source_files() -> tuple[ImplementationSourceFile, ...]:
    implementation_root = Path(__file__).resolve().parents[4]
    return tuple(
        ImplementationSourceFile(
            relative_path=relative_path,
            sha256=sha256(implementation_root / relative_path),
        )
...
def _make_execution_contract(
    *,
    replay: Exact16KRunnerSourceReplayAudit,
    ...
    values = {
        ...
        "provider_usage_semantics_contract_id": provider_usage_semantics.contract_id,
        "job_ids": tuple(sorted(item.job_id for item in static.predecessor_manifest.jobs)),
        "runner_implementation_source_files": _source_files(),
    }
    provisional = Exact16KExecutionContract.model_construct(contract_id="pending", **values)
    return Exact16KExecutionContract(
        contract_id=exact_16k_execution_contract_id(provisional),
        **values,
    )
...
def _make_client_binding_audit(
    *,
    ...
    certificate = certify_exact_16k_request_pre_call(
        config=model_config,
    ...
    provisional = Exact16KClientBindingAudit.model_construct(audit_id="pending", **values)
    return Exact16KClientBindingAudit(
        audit_id=client_binding_audit_id(provisional),
        **values,
    )


def _make_provider_usage_fixture_audit(
    *,
    static: Any,
    execution_contract: Exact16KExecutionContract,
    provider_usage_semantics: ProviderUsageSemanticsContract,
    ...
    primary = _first_primary_prompt(runtime_binding(static, job))

    def run_length_case(root: Path, completion_tokens: int) -> tuple[Any, LLMClientError]:
        delegate = ScriptedProviderClient(
        ...
        try:
            ledger.invoke(prepared, logical_request_index=0)
        except LLMClientError as exc:
            return ledger, exc
        raise ValueError("v26.104 Usage length fixture unexpectedly returned usable content")

    with tempfile.TemporaryDirectory(prefix="v26_104_usage_fixture_") as temporary:
        root = Path(temporary)
        exact_ledger, exact_error = run_length_case(root / "exact", 16384)
        margin_ledger, margin_error = run_length_case(root / "margin", 16385)
        excess_ledger, excess_error = run_length_case(root / "excess", 16386)
        exact_audit = exact_ledger.audit()
        margin_audit = margin_ledger.audit()
        excess_audit = excess_ledger.audit()

        normal_delegate = ScriptedProviderClient(
            static.agent_model_config,
            (FixtureEvent(payload={"action": "call_tool", "tool_id": "fixture", "arguments": {}}),),
        )
        normal_ledger = JournaledExact16KClient(
            normal_delegate,
            execution_contract=execution_contract,
            job=job,
            provider_usage_semantics=provider_usage_semantics,
            completion_protocol=static.completion_bound_protocol,
            output_dir=root / "reserves",
        )
        normal_prepared = normal_ledger.prepare_request(
            phase="primary",
            request_kind="decision",
            primary_prompt=primary,
            prompt=primary,
        ...
        normal_ledger.invoke(normal_prepared, logical_request_index=0)
        normal_audit = normal_ledger.audit()

        margin_record = margin_audit.usage_records[0]
        excess_rescue_blocked = False
        try:
            excess_ledger.prepare_request(
                phase="rescue",
                request_kind="decision",
                primary_prompt=primary,
                prompt=primary,
            ...
            excess_rescue_blocked = True
        checks = (
            exact_audit.status == "passed",
            exact_error.failure_artifact is not None,
            margin_audit.status == "passed",
            margin_audit.one_token_accounting_margin_count == 1,
            margin_record.counted_tokens == margin_record.total_tokens,
            margin_error.failure_artifact is not None,
            excess_audit.status == "failed",
            excess_audit.two_or_more_excess_token_count == 1,
            excess_rescue_blocked,
            normal_audit.status == "passed",
            normal_prepared.request_binding_certificate.request_max_tokens == 16384,
            normal_prepared.provider_budget_certificate.completion_token_upper_bound == 16385,
            normal_prepared.provider_budget_certificate.contract_repair_reserve_tokens == 16385,
            normal_prepared.provider_budget_certificate.final_answer_reserve_tokens == 16385,
        )
        if not all(checks):
            raise ValueError("v26.104 Provider Usage semantics fixture failed")

    values = {"execution_contract_id": execution_contract.contract_id}
    provisional = ProviderUsageFixtureAudit.model_construct(audit_id="pending", **values)
    return ProviderUsageFixtureAudit(
        audit_id=provider_usage_fixture_audit_id(provisional),
        **values,
    )
...
def _make_runner_fixture_audit(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="v26_104_runner_fixture_") as temporary:
        root = Path(temporary)
        ...
        for job in static.predecessor_manifest.jobs:
            ...
            scored = score_exact_16k_raw_execution(
                raw=raw,
        ...
        for index, failure_type in enumerate(RESCUE_FAILURE_TYPES):
            ...
            values = {
                ...
                "all_rescue_calls_exact_16k_request_bound": all(
                    item.request_binding_certificate is not None
                    and item.request_binding_certificate.request_max_tokens == 16384
        ...
        exhausted_result = score_exact_16k_raw_execution(
            raw=exhausted,
            prepared=prepared_stub,
            binding=exhausted_binding,
            output_dir=exhausted_output,
        )
        telemetry_result = score_exact_16k_raw_execution(
...
def _make_precall_recovery_audit(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="v26_104_precall_recovery_") as temporary:
        root = Path(temporary)
        output = root / "recoverable"
        client = ScriptedProviderClient(static.agent_model_config, events)
        first = execute_exact_16k_job_raw(
            job=job,
            execution_contract=execution_contract,
            provider_usage_semantics=provider_usage_semantics,
            completion_protocol=static.completion_bound_protocol,
        ...
        recovered = execute_exact_16k_job_raw(
            job=job,
            execution_contract=execution_contract,
            provider_usage_semantics=provider_usage_semantics,
            completion_protocol=static.completion_bound_protocol,
        ...
        oversized_ledger = JournaledExact16KClient(
            oversized_client,
            execution_contract=execution_contract,
            job=job,
            provider_usage_semantics=provider_usage_semantics,
        ...
        resource_ledger = JournaledExact16KClient(
            resource_client,
            execution_contract=execution_contract,
            job=job,
            provider_usage_semantics=provider_usage_semantics,
        ...
        resource_ledger._cumulative_tokens = 230000
        ...
        kind_ledger = JournaledExact16KClient(
            kind_client,
            execution_contract=execution_contract,
            job=job,
            provider_usage_semantics=provider_usage_semantics,
        ...
        off_ledger = JournaledExact16KClient(
            off_client,
            execution_contract=execution_contract,
            job=job,
            provider_usage_semantics=provider_usage_semantics,
    ...
    values = {
        ...
        "off_compiler_rescue_exact_16k_request_bound": (
            off_prepared.request_binding_certificate.request_max_tokens == 16384
        ),
    }
...
def _first_primary_prompt(binding: Any) -> str:
    ...
    if progress["final_answer_allowed"]:
        raise ValueError("v26.104 representative fixture unexpectedly starts final-ready")
    condition = (
        None
...
def _mutation(name: str, callback: Callable[[], Any]) -> MutationResult:
    ...
    raise AssertionError(f"v26.104 destructive mutation was accepted: {name}")
...
def _make_destructive_audit(
    *,
    ...
    def use_8k_config() -> None:
        payload = base_config.model_dump(mode="python")
        payload["max_output_tokens"] = 8192
        require_exact_16k_model_config(AgentModelConfig.model_validate(payload))

    mutations = (
        _mutation("changed_source_digest", mutate_replay),
        _mutation(
            "completion_bound_8192", lambda: validate_contract(completion_upper_bound_tokens=8192)
        ),
        _mutation(
            "completion_bound_32768",
            lambda: validate_contract(completion_upper_bound_tokens=32768),
        ),
        _mutation(
            "rollout_bound_320000", lambda: validate_contract(rollout_upper_bound_tokens=320000)
        ),
        _mutation(
        ...
        _mutation(
            "automatic_higher_bound",
            lambda: validate_contract(automatic_higher_bound_escalation_allowed=True),
        ),
        _mutation(
        ...
        _mutation("8k_model_config", use_8k_config),
        _mutation(
            "request_max_tokens_8192", lambda: mutate_request_certificate(request_max_tokens=8192)
        ),
        _mutation(
        ...
        _mutation(
            "automatic_interpretation_higher_bound_escalation",
            lambda: validate_interpretation(automatic_higher_bound_escalation_allowed=True),
        ),
        _mutation(
            "semantic_rescue",
        ...
        _mutation(
            "provider_accounting_margin_two",
            lambda: validate_contract(provider_reported_accounting_margin_tokens=2),
        ),
        _mutation(
            "provider_accounting_ceiling_16386",
            lambda: validate_contract(maximum_accounting_admissible_completion_tokens=16386),
        ),
        _mutation(
            "reported_usage_clipping_enabled",
            lambda: validate_contract(reported_usage_charged_without_clipping=False),
        ),
        _mutation(
            "accounting_margin_changes_completion",
            lambda: validate_contract(accounting_margin_cannot_change_completion_usability=False),
        ),
        _mutation(
            "single_stage_ladder_extended",
            lambda: validate_interpretation(single_stage_completion_bound_ladder_ends_at_16k=False),
        ),
    )
...
def build_exact_16k_runner_preflight(
    *,
    run_id: str,
    output_dir: Path,
    package_root: Path,
    ...
    if run_id != RUNNER_PREFLIGHT_RUN_ID:
        raise ValueError("v26.104 Runner preflight run identity changed")
    replay = build_runner_source_replay(package_root)
    static = load_static_inputs(package_root)
    provider_usage_semantics = _make_provider_usage_semantics(static)
    ...
    usage_fixture = _make_provider_usage_fixture_audit(
        static=static,
        execution_contract=execution_contract,
        provider_usage_semantics=provider_usage_semantics,
    )
    ...
    payloads: tuple[tuple[str, BaseModel, int], ...] = (
        ...
        ("provider_usage_semantics_contract.json", provider_usage_semantics, 1),
        ("execution_contract.json", execution_contract, 1),
        ("client_request_binding_audit.json", client_audit, 1),
        ("provider_usage_fixture_audit.json", usage_fixture, 1),
    ...
    values = {
        ...
        "provider_usage_fixture_audit_id": usage_fixture.audit_id,
    ...
    provisional = Exact16KRunnerPreflightReport.model_construct(report_id="pending", **values)
    report = Exact16KRunnerPreflightReport(
        report_id=exact_16k_runner_preflight_report_id(provisional),
        **values,
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build the Finance v26.104 exact-16K Runner preflight"
    )
