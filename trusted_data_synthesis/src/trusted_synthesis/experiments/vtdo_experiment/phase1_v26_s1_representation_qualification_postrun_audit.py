...
RUN_ID: Final = "finance_v26_135_s1_representation_qualification_postrun_audit_v1_20260824"
EXECUTION_DIR: Final = execution.OUTPUT_DIR
OUTPUT_DIR: Final = (
    "artifacts/vtdo_experiment/"
    "finance_v26_135_s1_representation_qualification_postrun_audit_v1_20260824"
)
IMPLEMENTATION_PATH: Final = (
    "src/trusted_synthesis/experiments/vtdo_experiment/"
    "phase1_v26_s1_representation_qualification_postrun_audit.py"
)
NEXT_STAGE: Final = "s1_representation_root_cause_audit_only"

EXPECTED_EXECUTION_REPORT_ID: Final = (
    "finance_v26_s1_qualification_execution_report:"
    "0027e364c5dd830e597a6d2f14dfba6fd979d6139c8287ab03b129a0ef65d594"
)
EXPECTED_EXECUTION_REPORT_SHA256: Final = (
    "dc0b6f824f8e2cd061a2df60780e209b38a15dc61505899938ec81b62e26c333"
)
EXPECTED_EXECUTION_SOURCE_REPLAY_ID: Final = (
    "finance_v26_s1_execution_source_replay:"
    "f83d350cb1679021aedb8e0d98dbeaba1417b0c42542796a7cff0727b3f71236"
)
EXPECTED_PREEXECUTION_BINDING_ID: Final = (
    "finance_v26_s1_execution_preexecution_binding:"
    "70d19d60ca71cbb56d609e7b89826fc7eea9b9123b63c6da062c2c114868dfeb"
)
EXPECTED_RAW_LINEAGE_ID: Final = (
    "finance_v26_s1_qualification_raw_lineage:"
    "24ec6c82b02ffdf94d5ecdc3a893edc8cb2f5bb634b1e0e496f1c72f482bb628"
)
EXPECTED_PRIVACY_REJECTED_JOB_ID: Final = (
    "finance_v26_s1_qualification_job:"
    "33f02f1c1cb26e53f61fd27f2420b91c32d39af94f08c5073562bced173838fb"
)
...
EXECUTION_TOP_LEVEL_FILES: Final = (
    ...
    "frozen_public_progress_vector_contract.json",
    "frozen_qualification_source_separation_audit.json",
    "frozen_s1_qualification_contract.json",
    "frozen_s1_qualification_manifest.json",
    "frozen_s1_qualification_outcome_contract.json",
    "frozen_s1_qualification_resource_contract.json",
    "frozen_s1_qualification_runner_contract.json",
    "online_source_replay_audit.json",
    "preexecution_binding_audit.json",
    "raw_lineage_audit.json",
    "report.json",
    "s1_qualification_choice_diagnostics.json",
    "s1_qualification_job_results.checkpoint.jsonl",
    "s1_qualification_job_results.json",
)
...
class SourceReplayEntry(FrozenModel):
    ...
    source_kind: Literal[
        "v26_134_transitive_source",
        "v26_134_execution_file",
        "v26_135_implementation",
    ]
...
class PostrunSourceReplayAudit(FrozenModel):
    ...
    transitive_source_file_count: Literal[3225] = 3225
    execution_file_count: Literal[638] = 638
    implementation_file_count: Literal[1] = 1
    replayed_file_count: Literal[3864] = 3864
    replay_pass_count: Literal[3864] = 3864
    entries: tuple[SourceReplayEntry, ...] = Field(min_length=3864, max_length=3864)
    ...
    schema_version: Literal["finance_v26_s1_postrun_source_replay.v1"] = (
        "finance_v26_s1_postrun_source_replay.v1"
    )
    ...
    def validate_audit(self) -> PostrunSourceReplayAudit:
        ...
        if (
            ...
            raise ValueError("v26.135 source replay changed")
        if self.audit_id != _identity(
            self,
            "audit_id",
            "finance_v26_s1_postrun_source_replay:",
        ):
            raise ValueError("v26.135 source replay identity changed")
        return self
...
class IndependentRawReconstructionAudit(FrozenModel):
    ...
    provider_call_count: Literal[197] = 197
    transport_invocation_count: Literal[197] = 197
    provider_envelope_count: Literal[197] = 197
    public_projection_count: Literal[197] = 197
    complete_provider_pair_count: Literal[197] = 197
    validated_public_payload_count: Literal[196] = 196
    privacy_rejected_payload_count: Literal[1] = 1
    provider_failure_no_payload_count: Literal[0] = 0
    http_success_call_count: Literal[197] = 197
    exact_model_call_count: Literal[197] = 197
    thinking_telemetry_call_count: Literal[197] = 197
    complete_usage_call_count: Literal[197] = 197
    semantic_choice_count: Literal[141] = 141
    reversible_commit_count: Literal[140] = 140
    public_observation_count: Literal[125] = 125
    progress_event_count: Literal[125] = 125
    exact_final_payload_count: Literal[10] = 10
    completed_result_count: Literal[10] = 10
    replay_v3_pass_count: Literal[32] = 32
    independently_valid_trajectory_count: Literal[9] = 9
    exact_byte_descriptor_pass_count: Literal[623] = 623
    unique_envelope_id_count: Literal[197] = 197
    unique_projection_id_count: Literal[197] = 197
    unique_transport_certificate_id_count: Literal[197] = 197
    ...
    report_aggregate_match_count: Literal[33] = 33
    report_aggregate_field_count: Literal[33] = 33
    provider_calls_during_audit: Literal[0] = 0
    schema_version: Literal["finance_v26_s1_independent_raw_reconstruction.v1"] = (
        "finance_v26_s1_independent_raw_reconstruction.v1"
    )
    ...
    def validate_audit(self) -> IndependentRawReconstructionAudit:
        if self.report_aggregate_match_count != self.report_aggregate_field_count:
            raise ValueError("v26.135 independent aggregate reconstruction changed")
        if self.audit_id != _identity(
            self,
            "audit_id",
            "finance_v26_s1_independent_raw_reconstruction:",
        ):
            raise ValueError("v26.135 Raw reconstruction identity changed")
        return self
...
class QualificationGateAudit(FrozenModel):
    ...
    privacy_gate_failure_job_count: Literal[1] = 1
    ...
    combined_integrity_gate_failure_job_count: Literal[1] = 1
    zero_integrity_failure_gate_passed: Literal[False] = False
    representation_qualification_gate_passed: Literal[False] = False
    first_action_failure_job_ids: tuple[str, ...] = (EXPECTED_PRIVACY_REJECTED_JOB_ID,)
    terminal_counts: dict[str, int] = {
        "model_invalid_trajectory": 23,
        "model_valid_trajectory": 9,
    }
    ordinary_detour_job_distribution: dict[str, int] = {"0": 30, "1": 2, "2+": 0}
    detour_measurement_support_exit_job_count: Literal[0] = 0
    program_closed_job_count: Literal[24] = 24
    exact_final_abi_job_count: Literal[10] = 10
    independently_valid_trajectory_count: Literal[9] = 9
    ...
    status: Literal["failed_zero_integrity_tolerance"] = "failed_zero_integrity_tolerance"
    provider_calls_during_audit: Literal[0] = 0
    schema_version: Literal["finance_v26_s1_qualification_gate_audit.v1"] = (
        "finance_v26_s1_qualification_gate_audit.v1"
    )
    ...
    def validate_audit(self) -> QualificationGateAudit:
        if (
            ...
            raise ValueError("v26.135 qualification Gate changed")
        if self.audit_id != _identity(
            self,
            "audit_id",
            "finance_v26_s1_qualification_gate_audit:",
        ):
            raise ValueError("v26.135 Gate-audit identity changed")
        return self


class PrivacyRejectionAudit(FrozenModel):
    audit_id: str = Field(min_length=1)
    rejected_job_id: str = EXPECTED_PRIVACY_REJECTED_JOB_ID
    ...
    http_success: Literal[True] = True
    response_model: Literal["deepseek-v4-flash"] = "deepseek-v4-flash"
    thinking_present: Literal[True] = True
    reasoning_tokens: Literal[3822] = 3822
    prompt_tokens: Literal[3258] = 3258
    completion_tokens: Literal[6965] = 6965
    total_tokens: Literal[10223] = 10223
    public_content_length: Literal[10696] = 10696
    public_content_sha256: Literal[
        "f6bdf28ff6ae722176fc4b010c1426cf2b75af43803141729938e0a191b6cd96"
    ] = "f6bdf28ff6ae722176fc4b010c1426cf2b75af43803141729938e0a191b6cd96"
    projection_status: Literal["privacy_rejected"] = "privacy_rejected"
    failure_family: Literal["payload_privacy_failure"] = "payload_privacy_failure"
    failure_subtype: Literal["public_payload_omitted_after_privacy_rejection"] = (
        "public_payload_omitted_after_privacy_rejection"
    )
    exact_rejected_payload_persisted: Literal[False] = False
    exact_rejected_key_persisted: Literal[False] = False
    private_reasoning_content_or_hash_persisted: Literal[False] = False
    envelope_projection_pair_complete: Literal[True] = True
    model_result_not_instrument_failure: Literal[True] = True
    first_action_interface_qualified: Literal[False] = False
    exact_semantic_cause_recoverable_from_persisted_artifacts: Literal[False] = False
    exact_semantic_cause_claimed: Literal[False] = False
    privacy_persistence_defect_observed: Literal[False] = False
    gate_failure_caused_by_zero_privacy_tolerance: Literal[True] = True
    schema_version: Literal["finance_v26_s1_privacy_rejection_audit.v1"] = (
        "finance_v26_s1_privacy_rejection_audit.v1"
    )

    @model_validator(mode="after")
    def validate_audit(self) -> PrivacyRejectionAudit:
        if self.audit_id != _identity(
            self,
            "audit_id",
            "finance_v26_s1_privacy_rejection_audit:",
        ):
            raise ValueError("v26.135 privacy-rejection identity changed")
        return self
...
class OutcomeInterpretation(FrozenModel):
    ...
    privacy_rejection_audit_id: str = Field(min_length=1)
    entry_quantity_and_cell_coverage_passed: Literal[True] = True
    qualification_gate_passed: Literal[False] = False
    sole_gate_blocker: Literal["one_privacy_rejected_job_under_zero_tolerance"] = (
        "one_privacy_rejected_job_under_zero_tolerance"
    )
    s1_is_not_interface_floor_claim_authorized: Literal[False] = False
    ...
    exact_rejected_payload_recovery_authorized: Literal[False] = False
    protocol_candidate_model_thinking_resource_or_counter_change_authorized: Literal[False] = False
    only_credential_free_representation_root_cause_audit_authorized: Literal[True] = True
    full_trajectory_result_is_repeated_engineering_source_diagnostic: Literal[True] = True
    production_contribution: Literal[0] = 0
    schema_version: Literal["finance_v26_s1_qualification_outcome_interpretation.v1"] = (
        "finance_v26_s1_qualification_outcome_interpretation.v1"
    )
    ...
    def validate_interpretation(self) -> OutcomeInterpretation:
        if self.interpretation_id != _identity(
            self,
            "interpretation_id",
            "finance_v26_s1_qualification_outcome_interpretation:",
        ):
            raise ValueError("v26.135 outcome interpretation identity changed")
        return self
...
class DestructiveAudit(FrozenModel):
    ...
    provider_calls: Literal[0] = 0
    stage_two_provider_calls: Literal[0] = 0
    schema_version: Literal["finance_v26_s1_postrun_destructive.v1"] = (
        "finance_v26_s1_postrun_destructive.v1"
    )

    @model_validator(mode="after")
    def validate_audit(self) -> DestructiveAudit:
        if len(self.mutations) != self.mutation_count:
            raise ValueError("v26.135 destructive denominator changed")
        if self.audit_id != _identity(
            self,
            "audit_id",
            "finance_v26_s1_postrun_destructive:",
        ):
            raise ValueError("v26.135 destructive identity changed")
        return self
...
class ProspectiveTransitionContract(FrozenModel):
    ...
    qualification_gate_passed: Literal[False] = False
    credential_free_root_cause_audit_authorized: Literal[True] = True
    ...
    execution_rerun_recovery_or_reclassification_authorized: Literal[False] = False
    exact_rejected_payload_or_key_recovery_authorized: Literal[False] = False
    s1_candidate_grammar_model_thinking_resource_or_counter_change_authorized: Literal[False] = (
        False
    )
    training_release_or_production_authorized: Literal[False] = False
    role_source_model_exposure_count: Literal[0] = 0
    status: Literal["s1_qualification_failed_closed"] = "s1_qualification_failed_closed"
    schema_version: Literal["finance_v26_s1_postrun_transition.v1"] = (
        "finance_v26_s1_postrun_transition.v1"
    )
    ...
    def validate_contract(self) -> ProspectiveTransitionContract:
        if self.contract_id != _identity(
            ...
            raise ValueError("v26.135 transition identity changed")
        return self
...
class PostrunAuditReport(FrozenModel):
    ...
    qualification_gate_passed: Literal[False] = False
    independently_valid_trajectory_count: Literal[9] = 9
    ordinary_detour_job_count: Literal[2] = 2
    ...
    production_contribution: Literal[0] = 0
    next_permitted_stage: str = NEXT_STAGE
    status: Literal["s1_representation_qualification_failed_closed"] = (
        "s1_representation_qualification_failed_closed"
    )
    schema_version: Literal["finance_v26_s1_qualification_postrun_audit_report.v1"] = (
        "finance_v26_s1_qualification_postrun_audit_report.v1"
    )
    ...
    def validate_report(self) -> PostrunAuditReport:
        if self.report_id != _identity(
            ...
            raise ValueError("v26.135 report identity changed")
        return self
    ...
    *,
    ...
    for root in (implementation_root, package_root):
        ...
        if candidate.is_file() and _sha256(candidate) == expected_sha256:
            return candidate
    raise ValueError(f"v26.135 cannot replay bound file: {relative_path}")
...
def _execution_files(execution_dir: Path) -> tuple[Path, ...]:
    ...
    if len(files) != 638:
        raise ValueError("v26.135 execution-file denominator changed")
    roots = {path.name for path in files if path.parent == execution_dir}
    if roots != set(EXECUTION_TOP_LEVEL_FILES):
        raise ValueError("v26.135 execution top-level file set changed")
    return files
...
def _build_source_replay(
    *,
    ...
    if (
        ...
        raise ValueError("v26.135 execution report or source replay changed")
    ...
    for item in source.entries:
        ...
        entries[item.relative_path] = SourceReplayEntry(
            ...
            source_kind="v26_134_transitive_source",
    ...
    for path in _execution_files(execution_dir):
        ...
        entries[relative] = SourceReplayEntry(
            ...
            source_kind="v26_134_execution_file",
    ...
    entries[IMPLEMENTATION_PATH] = SourceReplayEntry(
        ...
        source_kind="v26_135_implementation",
        expected_sha256=digest,
        observed_sha256=digest,
...
def _load_execution_objects(execution_dir: Path) -> dict[str, Any]:
    ...
    qualification = preflight.S1RepresentationQualificationContract.model_validate(
        _load(execution_dir / "frozen_s1_qualification_contract.json")
    )
    ...
    outcome = preflight.S1QualificationOutcomeContract.model_validate(
        _load(execution_dir / "frozen_s1_qualification_outcome_contract.json")
    )
    runner = preflight.S1QualificationRunnerContract.model_validate(
        _load(execution_dir / "frozen_s1_qualification_runner_contract.json")
    )
    resource = preflight.S1QualificationResourceContract.model_validate(
        _load(execution_dir / "frozen_s1_qualification_resource_contract.json")
    )
    progress = preflight.PublicProgressVectorContract.model_validate(
        _load(execution_dir / "frozen_public_progress_vector_contract.json")
    )
    separation = preflight.QualificationSourceSeparationAudit.model_validate(
        _load(execution_dir / "frozen_qualification_source_separation_audit.json")
    )
    ...
    results = tuple(
        ...
        for item in _load(execution_dir / "s1_qualification_job_results.json")
    )
    checkpoint = tuple(
        execution.QualificationJobResult.model_validate_json(line)
        for line in (execution_dir / "s1_qualification_job_results.checkpoint.jsonl")
    ...
    diagnostics = tuple(
        ...
        for item in _load(execution_dir / "s1_qualification_choice_diagnostics.json")
    )
    if (
        report.report_id != EXPECTED_EXECUTION_REPORT_ID
        or source.audit_id != EXPECTED_EXECUTION_SOURCE_REPLAY_ID
        ...
        or progress.contract_id != execution.EXPECTED_PROGRESS_CONTRACT_ID
        or separation.audit_id != execution.EXPECTED_SOURCE_SEPARATION_ID
        or transition.contract_id != execution.EXPECTED_TRANSITION_ID
        or len(results) != len(checkpoint) != 32
        or len(diagnostics) != 141
    ):
        raise ValueError("v26.135 execution object binding changed")
    if tuple(item.model_dump(mode="json") for item in results) != tuple(
        item.model_dump(mode="json") for item in checkpoint
    ):
        raise ValueError("v26.135 checkpoint and final Job results diverged")
    if tuple(item.job_id for item in results) != tuple(item.job_id for item in manifest.jobs):
        raise ValueError("v26.135 Job-result order changed")
    return {
        "report": report,
        "manifest": manifest,
        "outcome": outcome,
...
def _reconstruct_raw(
    *,
    ...
    manifest = cast(preflight.S1QualificationManifest, objects["manifest"])
    ...
    for job, result in zip(manifest.jobs, results, strict=True):
        ...
        if (
            ...
            raise ValueError("v26.135 Raw descriptor changed")
        ...
        if raw.job != job or raw.runner_contract_id != EXPECTED_RUNNER_CONTRACT_ID:
            raise ValueError("v26.135 Raw Job or Runner binding changed")
        descriptor_passes += 1
        old_job, binding = preflight._job_context(loaded, job)  # noqa: SLF001
        if old_job.job_id != job.predecessor_job_id:
            raise ValueError("v26.135 predecessor Job binding changed")
        ...
        if valid != result.independent_trajectory_validity:
            raise ValueError("v26.135 independent validity changed")
        ...
        if independent_first != raw.first_action_interface_qualified or (
            ...
            raise ValueError("v26.135 first-action qualification changed")
        ...
        for descriptor in raw.provider_envelope_artifacts:
            ...
            if _sha256(path) != descriptor.sha256 or path.stat().st_size != descriptor.byte_count:
                raise ValueError("v26.135 Envelope descriptor changed")
        ...
        for descriptor in raw.public_payload_projection_artifacts:
            path = execution_dir / descriptor.relative_path
            if _sha256(path) != descriptor.sha256 or path.stat().st_size != descriptor.byte_count:
                raise ValueError("v26.135 Projection descriptor changed")
        ...
        for descriptor in raw.transport_invocation_artifacts:
            path = execution_dir / descriptor.relative_path
            if _sha256(path) != descriptor.sha256 or path.stat().st_size != descriptor.byte_count:
                raise ValueError("v26.135 Transport descriptor changed")
    ...
    independently_reconstructed = {
        ...
        "combined_integrity_gate_failure_job_count": sum(
        ...
        "representation_qualification_gate_passed": False,
    }
    mismatches = {
    ...
    if mismatches:
        raise ValueError(f"v26.135 report aggregate mismatch: {mismatches}")
    if (
        call_count != lineage.provider_call_count
        or invocation_count != lineage.transport_inclusive_invocation_count
        or descriptor_passes != 623
        or len(set(envelope_ids)) != 197
        or len(set(projection_ids)) != 197
        or len(set(transport_ids)) != 197
        or exact_model != 197
        or thinking != 197
        or usage != 197
        or replay_pass != 32
        ...
        or len(privacy_rows) != 1
    ):
        raise ValueError("v26.135 independent Raw denominator changed")
    values: dict[str, Any] = {
        "semantic_choice_count": choices,
...
def _make_privacy_audit(
    privacy_rows: Sequence[Mapping[str, Any]],
) -> PrivacyRejectionAudit:
    if len(privacy_rows) != 1:
        raise ValueError("v26.135 privacy-rejection denominator changed")
    row = privacy_rows[0]
    job = cast(preflight.S1QualificationJob, row["job"])
    result = cast(execution.QualificationJobResult, row["result"])
    raw = cast(preflight.S1QualificationRawExecution, row["raw"])
    envelope = cast(privacy_runner.PrivacyFirstProviderEnvelope, row["envelope"])
    projection = cast(privacy_runner.PublicPayloadProjection, row["projection"])
    telemetry = envelope.provider_telemetry
    attempt = raw.attempts[0]
    redacted = telemetry.response_shape.get("redacted_response_envelope")
    if not isinstance(redacted, Mapping):
        raise ValueError("v26.135 privacy row lacks its redacted response Envelope")
    values: dict[str, Any] = {
        "rejected_job_id": job.job_id,
        ...
        "public_content_length": redacted.get("public_content_length"),
        "public_content_sha256": redacted.get("public_content_sha256"),
        "projection_status": projection.projection_status,
        "failure_family": projection.failure_family,
        "failure_subtype": projection.failure_subtype,
        "first_action_interface_qualified": result.first_action_interface_qualified,
    }
    if (
        job.job_id != EXPECTED_PRIVACY_REJECTED_JOB_ID
        or projection.response_payload is not None
        or attempt.payload_projection_status != "privacy_rejected"
        or result.instrument_failure
        or raw.completed_result is not None
    ):
        raise ValueError("v26.135 privacy-rejection interpretation changed")
    provisional = PrivacyRejectionAudit.model_construct(audit_id="pending", **values)
    return PrivacyRejectionAudit(
        audit_id=_identity(
            provisional,
            "audit_id",
            "finance_v26_s1_privacy_rejection_audit:",
...
def _make_interpretation(
    ...
    privacy: PrivacyRejectionAudit,
) -> OutcomeInterpretation:
    values = {
        "gate_audit_id": gate.audit_id,
        "privacy_rejection_audit_id": privacy.audit_id,
    }
...
def _expect_rejected(name: str, callback: Callable[[], Any]) -> MutationResult:
    ...
    raise ValueError(f"v26.135 destructive mutation was accepted: {name}")
...
def _make_destructive(
    *,
    ...
    mutations = (
        _expect_rejected(
            "gate_pass_with_privacy_failure",
            lambda: QualificationGateAudit.model_validate(
                gate.model_copy(
                    update={"representation_qualification_gate_passed": True}
                ).model_dump(mode="json")
            ),
        ),
        _expect_rejected(
            "zero_integrity_pass_with_failure",
            lambda: QualificationGateAudit.model_validate(
                gate.model_copy(update={"zero_integrity_failure_gate_passed": True}).model_dump(
                    mode="json"
                )
            ),
        ),
        _expect_rejected(
            "entry_quantity_failure",
            lambda: QualificationGateAudit.model_validate(
                gate.model_copy(
        ...
        _expect_rejected(
            "detour_merged_into_model_invalid",
            lambda: QualificationGateAudit.model_validate(
                gate.model_copy(update={"detour_measurement_support_exit_job_count": 1}).model_dump(
                    mode="json"
                )
            ),
        ),
        _expect_rejected(
            "privacy_payload_claimed_persisted",
            lambda: PrivacyRejectionAudit.model_validate(
                privacy.model_copy(update={"exact_rejected_payload_persisted": True}).model_dump(
                    mode="json"
                )
            ),
        ),
        _expect_rejected(
            "privacy_key_claimed_persisted",
            lambda: PrivacyRejectionAudit.model_validate(
                privacy.model_copy(update={"exact_rejected_key_persisted": True}).model_dump(
                    mode="json"
                )
            ),
        ),
        _expect_rejected(
            "privacy_exact_cause_claim",
            lambda: PrivacyRejectionAudit.model_validate(
                privacy.model_copy(update={"exact_semantic_cause_claimed": True}).model_dump(
                    mode="json"
                )
            ),
        ),
        ...
        _expect_rejected(
            ...
            lambda: OutcomeInterpretation.model_validate(
                interpretation.model_copy(
                    update={"capability_or_reachability_execution_authorized": True}
                ).model_dump(mode="json")
            ),
        ),
        _expect_rejected(
            "provider_root_cause_call_claim",
            lambda: OutcomeInterpretation.model_validate(
                interpretation.model_copy(
                    update={
                        "only_credential_free_representation_root_cause_audit_authorized": False
                    }
                ).model_dump(mode="json")
            ),
        ),
...
def build_postrun_audit(
    *,
    ...
    raw, privacy_rows = _reconstruct_raw(
        objects=objects,
        package_root=package_root,
        implementation_root=implementation_root,
        execution_dir=execution_dir,
    ...
    privacy = _make_privacy_audit(privacy_rows)
    interpretation = _make_interpretation(gate, privacy)
    ...
    detail_values: tuple[tuple[str, BaseModel], ...] = (
        ...
        ("privacy_rejection_audit.json", privacy),
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Independently audit the completed v26.134 S1 qualification"
    )
