...
from .plan import SYSTEM, read_json, record, require, sha
...
def _policy(binding):
    ...
    return record(
        ...
        input=(
            "same-interaction actual HTTP request.messages, including unchanged original T SYSTEM"
        ),
...
def _candidate(candidate):
    ...
    require(
        ...
        "support_tokens.candidate_identity",
    )
