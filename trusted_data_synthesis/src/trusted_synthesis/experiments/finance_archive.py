...
from trusted_synthesis.experiments.binding_support import (
    exclude_forecast,
    reconstruct_binding,
    require_current_version,
    require_official_source,
    require_same_definition,
    require_same_frequency,
    require_same_scope,
    same_structural_cell,
)
...
FINANCE_ARCHIVE_PROVIDER_ID = "finance_archive_binding_provider"
FINANCE_ARCHIVE_PROVIDER_VERSION = "finance_archive_binding_provider.v6"
...
class FinanceArchiveBindingProvider:
    ...
    def __init__(
        ...
        *,
        ...
        self._constraint_validators = {
            ...
            "require_same_definition": require_same_definition,
            "require_same_frequency": require_same_frequency,
            "require_same_scope": require_same_scope,
        }
        pilot_config = FinancePilotConfig(
            pilot_id="finance_archive.binding_provider",
    ...
    def iter_candidates(
        ...
        for source_binding in bindings:
            ...
            if not same_structural_cell(source_cell, request.cell):
                continue
            binding = reconstruct_binding(case, pattern)
            required = tuple(
