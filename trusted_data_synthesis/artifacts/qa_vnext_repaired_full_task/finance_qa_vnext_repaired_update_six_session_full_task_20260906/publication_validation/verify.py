...
for row in report['session_rows']:
    ...
    for attempt in ledger['attempts']:
        ...
        require(outcome['host_repairs'] == [] and outcome['automatic_retries'] == 0,
                'publication.no_repair_or_retry')
...
for name in ['preparation', 'execution', 'reanalysis', 'guarded_reanalysis', 'readonly_verification',
             'publication_validation_initial_local_failure', 'publication_validation']:
