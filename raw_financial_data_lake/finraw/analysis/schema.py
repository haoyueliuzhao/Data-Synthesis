...
def _ddl(json_type: str, bool_type: str, timestamp_type: str) -> list[str]:
    ...
    return [
        ...
        CREATE TABLE IF NOT EXISTS analysis_candidates (
            ...
            peer_scope_id TEXT,
            expected_scope_entity_ids {json_type} NOT NULL,
            scope_membership_hash TEXT,
            scope_eligibility_policy_hash TEXT,
            peer_scope_contract {json_type} NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS analysis_claim_plans (
            ...
            forbidden_claim_types {json_type} NOT NULL,
            required_caveat_ids {json_type} NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS analysis_samples (
            ...
            conclusion_semantic_frame {json_type},
...
def ensure_analysis_schema(db: DBProtocol) -> None:
    ...
    migrations = {
        "analysis_candidates": {
            "peer_scope_type": "TEXT",
            "peer_scope_id": "TEXT",
            "expected_scope_entity_ids": json_type,
            "scope_membership_hash": "TEXT",
            "scope_eligibility_policy_hash": "TEXT",
            "peer_scope_contract": json_type,
        },
